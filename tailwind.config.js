...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        frontscreen:
          "linear-gradient(185deg, rgb(65,77,86) 0vh, rgb(39, 45, 54) 55vh, rgba(151, 185, 188, 0.2) calc(55vh + 1px), rgba(151, 185, 188, 0.5) 100%)",
        "frontscreen-big":
          "conic-gradient(from 275deg at 62vw 54vh, rgb(65,77,86), rgb(151, 185, 188), transparent)",
