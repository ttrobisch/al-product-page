  ...
  return (
    <>
      ...
      <div className="grid gap-14 p-[5vw]">
        ...
        <div className="-m-[5vw] mb-0 grid min-h-screen p-4">
        ...
        <div id="amrs" className="mx-auto w-full max-w-screen-2xl space-y-8">
        ...
        <div id="videos" className="mx-auto mb-24 w-full max-w-screen-2xl space-y-8">
