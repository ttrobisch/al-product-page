  ...
  return (
    <>
      <div
       ...
       justify-items-start gap-4 rounded-xl bg-frontscreen pl-8 pt-6 lg:grid-cols-[minmax(0,1fr)_minmax(600px,1fr)] lg:pl-32 lg:pt-8"
      >
        ...
        <div className={"text-l absolute right-6 top-5 text-white"}>
          ...
          <a
            className={`no-underline hover:underline ${
              currentLang === "en" || currentLang === "" ? "font-extrabold" : ""
            }`}
            href="/en"
          >
            {" "}
